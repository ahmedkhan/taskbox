...
const defaultTasks = [
  { id: "1", title: "Do this ", state: "TASK_INBOX" },
  { id: "2", title: "Do Something", state: "TASK_INBOX" },
  { id: "3", title: "Do Something More", state: "TASK_INBOX" },
  { id: "4", title: "Do again", state: "TASK_INBOX" },
];
